...
(***)
val bmc_invgen_step : bool -> S.t -> TransSys.t -> bool -> Numeral.t -> (string * Term.t) list -> (Lib.kind_module * Term.t) list -> Var.t list -> (string * Term.t) list * ((StateVar.t * Term.t list) list * (string * Term.t) list) list * (Var.t * Term.t) list * (Lib.kind_module * Term.t) list
